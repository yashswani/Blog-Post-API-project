...
app.patch("/posts/:id",(req,res)=>{
  ...
  const searchIndi=posts.findIndex((post)=>post.id===id);
  posts[searchIndi]=updatedPost;
...
app.delete("/posts/:id",(req,res)=>{
  ...
  if(searchIndex>=0){
    ...
    res.status(404).json({error: `your posts with id ${id} were not found. no posts deleted`});
  }
})
app.listen(port, () => {
